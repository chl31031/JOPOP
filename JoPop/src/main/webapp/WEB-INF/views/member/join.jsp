...
<div class="wrapper">
    ...
    <div class="wrap">
            ...
            <div class="id_wrap">
                ...
                <span class="final_id_ck">닉네임을 입력해주세요.</span>
            </div>
...
/* 유효성 검사 통과유무 변수 */
var idCheck = false;            // 닉네임
var pwCheck = false;            // 비번
var pwckCheck = false;            // 비번 확인
var pwckcorCheck = false;        // 비번 확인 일치 확인
var nameCheck = false;            // 이름
var emailCheck = false;            // 이메일 & 아이디 
...
$(document).ready(function(){
    ...
    $(".join_button").click(function(){
    	...
    	/* 입력값 변수 */
        var id = $('.id_input').val();                 // 닉네임 입력란
        var pw = $('.pw_input').val();                // 비밀번호 입력란
        var pwck = $('.pwck_input').val();            // 비밀번호 확인 입력란
        var name = $('.user_input').val();            // 이름 입력란
        var email = $('.email_input').val();            // 이메일 & 아이디 입력란
        ...
        /* 최종 유효성 검사 */
        if(idCheck&&pwCheck&&pwckCheck&&pwckcorCheck&&nameCheck&&emailCheck&&emailnumCheck&&addressCheck ){
...
$(".email_check_button").click(function(){
    ...
    $.ajax({
        ...
        success: function(data){
            checkBox.prop("disabled", false); // 입력란 활성화
